            ...
            <Stack spacing="8" w={["100%", "100%", "70%"]} pb="10">
              ...
              <Stack spacing="5" fontFamily={"Montserrat"}>
                ...
                <Text color="gray.700">
                  ...
                  devices such as Pressure transmitters, Temperature
                  transmitters, control valves, shut down valves, level
                  transmitters, Flow Transmitters, controllers, solenoid valves,
                  switches, pneumatic sensors, and transducers.
                </Text>
                ...
                <Text color="gray.700">
                  ...
                  System with Eclipse Ratiomatic burners, Temperature
                  controllers and safeguarding systems, Steam Bath Heating
                  systems and any other Heating and combustion systems.
                </Text>
                <Text color="gray.700">
                ...
                <Text color="gray.700">
                  ● Supply, Installation, Overhauling and Servicing, Stroking
                  and simulation of Control Valves and shut down valves.{" "}
                </Text>
                <Text color="gray.700">
                  ● Supply, Installation, Overhauling, Servicing and Setting of
                  Pressure Relieve Valves (PRVs), Pressure Safety Valve (PSVs)
                  and Vacuum Valves.
                </Text>
                <Text color="gray.700">
                ...
                <Text color="gray.700">
                  ● Turn around maintenance, Preventive maintenance and
                  Corrective Maintenance of Instruments and Vendor Packages.
                </Text>
                <Text color="gray.700">
                  ● Supply, Installation, maintenance and commissioning of
