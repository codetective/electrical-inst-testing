...
function index() {
  return (
    <>
      <SEO
        title={"Why Avetrix"}
        desc="We have years on umparalled experience in all aspects of our services, confirmed delivery and excellent customer relations."
        path="/why_us"
      />
      <Box>
        <PageTitleHero
                ...
                <GridItem colSpan={2}>
                  ...
                  >
                    ...
                    <Feature title="Unify your payments stack">
                      Manage all your online and offline sales in one place with
                      a single integration, simplifying reporting and
                      reconciliation.
                    </Feature>
                    <Feature title="Own your in-store experience">
                      {" "}
                      Provide a seamless customer experience across channels,
                      like reserving online and picking up in store.
                    </Feature>
                    ...
                    <Feature title="Clear overview for efficient tracking">
                      ...
                      with the clear overview in Dashboard. Fea
                    </Feature>
